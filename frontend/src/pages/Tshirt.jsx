...
function Tshirt({ searchWord }) {
  ...
  var productsTshirtInfo = productInfo.filter((x) => x.type === "T-shirt");

  function deleteProduct(id) {
    dispatch(deleteproduct(id));
  }

  var displayProductsTshirt = productsTshirtInfo
    .filter((product) => {
  ...
  const pageCount = Math.ceil(productsTshirtInfo.length / productsPerPage);
