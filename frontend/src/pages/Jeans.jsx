...
function Jeans({ searchWord }) {
  ...
  var productsJeansInfo = productInfo.filter((x) => x.type === "Jeans");

  function deleteProduct(id) {
    dispatch(deleteproduct(id));
  }

  var displayProductsJeans = productsJeansInfo
    .filter((product) => {
  ...
  const pageCount = Math.ceil(productsJeansInfo.length / productsPerPage);
